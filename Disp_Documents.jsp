...
<div class="container_form">
    <form action="Per_Off_Doc_display.jsp" method="post">
        ...
        <input type="submit" value="List Personal Documents">
    </form>
    ...
    <form action="Per_Off_Doc_display.jsp" method="post">
        ...
        <input type="hidden" name="login_pass" value="<%= login_pass %>">
        <input type="hidden" name="username" value="<%= uname %>">
        <input type="submit" value="List Official Documents">
    </form>

    <form action="Public_Document_display.jsp" method="post">
        <input type="hidden" name="documentType" id="public" value="Public">
        <input type="hidden" name="user_id" value="<%= user_id %>">
        <input type="hidden" name="login_pass" value="<%= login_pass %>">
        <input type="hidden" name="username" value="<%= uname %>">
        <input type="submit" value="List Public Documents">
    </form>
    
    <form action="All_Document_dispaly.jsp" method="post">
        <input type="hidden" name="documentType" id="All" value="All">
        <input type="hidden" name="user_id" value="<%= user_id %>">
        <input type="hidden" name="login_pass" value="<%= login_pass %>">
        <input type="hidden" name="username" value="<%= uname %>">
        <input type="submit" value="List All Documents">
    </form>
 </div>   
 <div class="container_form">
