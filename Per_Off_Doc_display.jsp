...
<body>
    <div class="container">
        ...
        String doc_type = request.getParameter("documentType");
        ...
        try {  		
            ...
            if (doc_type.equals("Official")) {
                ps = con.prepareStatement("SELECT * FROM off_documents WHERE doc_type = ? AND username = ?");
            } else if (doc_type.equals("Personal")) {
                ps = con.prepareStatement("SELECT * FROM per_documents WHERE doc_type = ? AND username = ?");
            }
            
            ps.setString(1, doc_type);
            ...
            if (data.isEmpty()) {
                out.print("<p>No " + doc_type + " documents found for username: " + uname + "</p>");
            } else {
                out.print("<table>");
