...
public class PubDoc_Scan_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Pub_Document emp = new Pub_Document();
		emp.setDoc_Id(id);
		emp.setDoc_Name(dn);
		emp.setDoc_type(dt);
		emp.setDoc_Password(pwd);
	...
	String query = "INSERT INTO pub_documents (id, doc_name, doc_type, doc_content, doc_owner, username) VALUES (?, ?, ?, ?, ?, ?);";
            ...
            preparedStatement.setString(6, request.getParameter("username"));
